...
# 👋 Halo, Saya **Dinda Aprilla Dalimunthe**!

<img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3000&pause=1000&color=A855F7&center=true&vCenter=true&multiline=true&width=600&height=80&lines=Software+Developer+%26+Data+Scientist;Machine+Learning+%7C+Deep+Learning+%7C+Computer+Vision;Mobile+App+%7C+Game+Dev+%7C+Web+Developer" alt="Typing SVG" />
...
```python
class DindaAprillaDalimunthe:
    def __init__(self):
        self.nama        = "Dinda Aprilla Dalimunthe"
        self.peran       = ["Software Developer", "Data Scientist", "Game Developer"]
        self.pendidikan  = "Fresh Graduate Teknik Informatika"
        self.email       = "da133450@gmail.com"
        self.lokasi      = "Indonesia 🇮🇩"
        
    def tech_stack(self):
        return {
            "AI / ML":       ["Python", "TensorFlow", "Keras", "EfficientNetB3",
                              "CatBoost", "SHAP", "SMOTE", "Scikit-learn"],
            "Mobile":        ["Flutter", "Dart", "SQLite", "Provider"],
            "Game Dev":      ["Godot Engine", "GDScript", "2D Physics"],
            "Web":           ["HTML5", "CSS3", "JavaScript", "React", "Supabase"],
            "Tools":         ["Git", "n8n Workflow", "Microsoft Office"],
        }
    
    def saat_ini(self):
        return "Membuka peluang kerja di bidang AI/ML, Mobile Dev, atau Game Dev 🎯"
```
...
|:---:|:---:|
| 📚 IPK / GPA | **3.8+** |
| 🚀 Total Proyek Akademik | **7+ Proyek** |
| 🎯 Akurasi Model ML Terbaik | **96.95%** (Mental Health) |
| 🖼️ Akurasi Computer Vision | **98.70%** (Korean Food) |
